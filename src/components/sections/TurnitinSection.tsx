      ...
      <div className="container-custom">
        ...
        >
          ...
          <p className="text-gray-600 text-lg">
            <span className="text-primary-800 font-bold text-2xl">Rp 4.000/CEK</span>
            <br />
        ...
        >
          <div className="flex items-center gap-3 mb-6">
            <FileCheck className="w-6 h-6 text-primary-800" />
            <h3 className="text-xl font-bold text-dark-800">Cek Turnitin</h3>
            <span className="text-sm text-gray-500 ml-auto">Harga Turnitin belum stabil</span>
          </div>
            ...
            {plans.map((plan, index) => (
              ...
              >
                ...
                <div className="text-center">
                  <p className="text-4xl font-black text-dark-800 mb-2">
                    {plan.price}
                  </p>
                  <p className="text-gray-500 font-medium">{plan.amount} Cek</p>
                </div>
                ...
                <motion.a
                  ...
                  className={`mt-6 block w-full text-center font-semibold py-3 px-6 rounded-xl ${
                    plan.badge
        ...
        >
          <div className="flex items-center gap-3 mb-6">
            ...
            <h3 className="text-xl font-bold text-dark-800">Cek AI (Detection)</h3>
          </div>
            ...
            {aiPlans.map((plan, index) => (
              ...
              >
                <div className="text-center">
                  ...
                  <p className="text-gray-500 font-medium">{plan.amount} Cek AI</p>
                </div>
                <ul className="mt-6 space-y-3">
                  <li className="flex items-center gap-2 text-sm text-gray-600">
                ...
                <motion.a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="mt-6 block w-full text-center bg-purple-600 text-white font-semibold py-3 px-6 rounded-xl"
                  whileHover={{ scale: 1.02 }}
                  whileTap={{ scale: 0.95 }}
                  transition={{ type: 'spring', stiffness: 400, damping: 17 }}
                >
