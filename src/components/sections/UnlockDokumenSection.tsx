...
const SiteCard = ({ name, price, index }: { name: string; price: string; index: number }) => (
  ...
  >
    ...
    <span className="text-primary-800 font-bold text-sm">{price}</span>
  </motion.div>
);
      ...
      <div className="container-custom">
        ...
        >
          <div className="flex items-center gap-2 mb-6">
            <FileKey className="w-5 h-5 text-primary-800" />
            <h3 className="text-xl font-bold text-dark-800">Platform Umum</h3>
          </div>
        ...
        >
          <div className="flex items-center gap-2 mb-6">
            ...
            <h3 className="text-xl font-bold text-dark-800">Platform Akademik</h3>
          </div>
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-4">
