...
const services = [
  ...
  { id: 88, category: 'uji-data', name: 'Olah Data SPSS', price: 'Chat Admin', icon: Database, badge: null },
  { id: 89, category: 'uji-data', name: 'Olah Data Matlab', price: 'Chat Admin', icon: Code, badge: null },
  { id: 90, category: 'uji-data', name: 'Olah Data TablePlus', price: 'Chat Admin', icon: Database, badge: null },
