...
const services = [
  ...
  { id: 13, category: 'joki-tugas', name: 'Olah Data Matlab', price: 'Chat Admin', icon: Code, badge: null },
  { id: 14, category: 'joki-tugas', name: 'Olah Data TablePlus', price: 'Chat Admin', icon: Database, badge: null },
  ...
  { id: 88, category: 'uji-data', name: 'Olah Data SPSS - Uji Validitas & Reliabilitas', price: '75k–200k', icon: BarChart, badge: null },
  { id: 89, category: 'uji-data', name: 'Olah Data SPSS - Uji Asumsi Klasik', price: '100k–250k', icon: BarChart, badge: null },
  { id: 90, category: 'uji-data', name: 'Olah Data SPSS - Analisis Regresi (Linier/Logistik)', price: '150k–300k', icon: BarChart, badge: null },
  { id: 91, category: 'uji-data', name: 'Olah Data SPSS - Uji Hipotesis (T-Test, F-Test, ANOVA)', price: '100k–250k', icon: BarChart, badge: null },
  { id: 92, category: 'uji-data', name: 'Olah Data SPSS - Uji Non-Parametrik', price: '150k–350k', icon: BarChart, badge: null },
  { id: 93, category: 'uji-data', name: 'Olah Data SPSS - Path Analysis & SEM', price: '300k–700k', icon: BarChart, badge: null },
  { id: 94, category: 'uji-data', name: 'Olah Data SPSS - Tabulasi & Cleaning Data Kuesioner', price: '50k–200k', icon: Database, badge: null },
  { id: 95, category: 'uji-data', name: 'Interpretasi & Pembahasan Output Statistik SPSS', price: '100k–300k', icon: BarChart, badge: null },
  { id: 96, category: 'uji-data', name: 'Olah Data Matlab - Komputasi & Analisis Numerik', price: '150k–450k', icon: Calculator, badge: null },
  { id: 97, category: 'uji-data', name: 'Olah Data Matlab - Pemrosesan Citra Digital (Image Processing)', price: '200k–600k', icon: Code, badge: null },
  { id: 98, category: 'uji-data', name: 'Olah Data Matlab - Signal Processing & Filter Design', price: '200k–500k', icon: Code, badge: null },
  { id: 99, category: 'uji-data', name: 'Olah Data Matlab - Machine Learning & Neural Network', price: '300k–800k', icon: Code, badge: null },
  { id: 100, category: 'uji-data', name: 'Olah Data Matlab - Simulasi & Modeling Sistem (Simulink)', price: '250k–750k', icon: Code, badge: null },
  { id: 101, category: 'uji-data', name: 'Olah Data Matlab - GUI & App Designer Development', price: '300k–900k', icon: Code, badge: null },
  { id: 102, category: 'uji-data', name: 'Olah Data TablePlus - Pembuatan Database & Relasi Tabel', price: '100k–300k', icon: Database, badge: null },
  { id: 103, category: 'uji-data', name: 'Olah Data TablePlus - Query SQL & Optimasi Query DDL/DML', price: '75k–250k', icon: Code, badge: null },
  { id: 104, category: 'uji-data', name: 'Olah Data TablePlus - Ekspor & Impor Data (CSV/JSON/SQL)', price: '50k–150k', icon: Database, badge: null },
  { id: 105, category: 'uji-data', name: 'Olah Data TablePlus - Migrasi & Sinkronisasi Database', price: '150k–400k', icon: Database, badge: null },
  { id: 106, category: 'uji-data', name: 'Olah Data TablePlus - Desain Skema Database (ERD)', price: '100k–350k', icon: Database, badge: null },
  { id: 107, category: 'uji-data', name: 'Olah Data TablePlus - Backup & Restore Database Server', price: '50k–200k', icon: Database, badge: null },
  { id: 108, category: 'uji-data', name: 'Olah Data TablePlus - Manajemen User Privilege & Akses DB', price: '75k–200k', icon: Database, badge: null },
