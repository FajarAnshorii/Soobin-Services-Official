  ...
  const services = [
    {
      ...
      price: 'Rp 650.000',
      features: ['1 Halaman Premium', 'Responsive Mobile-Friendly', 'SEO Optimization Basic', 'Integrasi WhatsApp Chat', 'Setup & Deploy ke Hosting Klien', 'Belum termasuk Hosting & Domain'],
      popular: false,
      tag: 'Starter'
    },
    {
      ...
      price: 'Rp 1.450.000',
      features: ['Hingga 5 Halaman Utama', 'Desain Custom Premium', 'Panel Admin Mudah (CMS)', 'SEO Setup Lengkap', 'Integrasi Maps & WhatsApp', 'Setup & Deploy (Belum termasuk hosting & domain)'],
      popular: true,
      tag: 'Best Seller'
    },
    {
      ...
      price: 'Rp 2.950.000',
      features: ['Halaman Produk & Kategori Unlimited', 'Keranjang Belanja Pintar', 'Integrasi Payment Gateway (Midtrans)', 'Kalkulasi Ongkir Realtime', 'Panel Kelola Pesanan & Stok', 'Setup & Deploy (Belum termasuk hosting & domain)'],
      popular: false,
      tag: 'Professional'
    }
  ];
